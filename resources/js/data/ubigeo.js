...
const UBIGEO = {
    ...
    'Áncash': {
        'Huaraz': ['Huaraz', 'Cochabamba', 'Colcabamba', 'Huanchay', 'Independencia', 'Jangas', 'La Libertad', 'Llanganuco', 'Pampas Grande', 'Paucará', 'Pira', 'Tarica'],
        ...
        'Carhuaz': ['Carhuaz', 'Acopampa', 'Amashca', 'Anta', 'Ataquero', 'Marcara', 'Pampas', 'San Miguel de Aco', 'Shilla', 'Tinco', 'Yungar'],
        ...
        'Huari': ['Huari', 'Anra', 'Cajay', 'Chavin de Huantar', 'Huacachi', 'Huacchis', 'Huachis', 'Huantar', 'Masin', 'Paucas', 'Ponto', 'Rahuapampa', 'Rapayán', 'San Marcos', 'San Pedro de Chana', 'Uco'],
        ...
        'Recuay': ['Recuay', 'Catac', 'Cotaparaco', 'Huayllapampa', 'Llacllin', 'Marca', 'Pampas Chico', 'Pampas Grande', 'Pátay', 'Pticara', 'Tapacocha', 'Tunel Puente'],
    ...
    'Apurímac': {
        ...
        'Andahuaylas': ['Andahuaylas', 'Andarapa', 'Chiara', 'Huancarama', 'Huancaray', 'Huayana', 'Kishuara', 'Pacobamba', 'Pacucha', 'Pampachiri', 'Pomacocha', 'San Antonio de Cachi', 'San Jerónimo', 'San Miguel de Chaccrampa', 'Santa María de Chicmo', 'Talavera', 'Tumay Huaraca', 'Turpo', 'Kaquiabamba', 'Los Chankas'],
        ...
        'Chincheros': ['Chincheros', 'Anco-Huallo', 'Cocharcas', 'Huaccana', 'Ocobamba', 'Ongoy', 'Uranmarca', 'Ranracancha', 'Rocchacc', 'El Porvenir de Anco-Huallo', 'Los Chankas de Andahuaylas'],
    ...
    'Ayacucho': {
        ...
        'Sucre': ['Querobamba', 'Belen', 'Chalcos', 'Chilcayoc', 'Huacaña', 'Morcolla', 'Paique', 'San Salvador de Quije', 'Santiago de Paucaray', 'Soras'],
    ...
    'Cajamarca': {
        ...
        'Jaén': ['Jaén', 'Bellavista', 'Chontalí', 'Colasay', 'Huabal', 'Las Pirias', 'Pomahuaca', 'Pucará', 'Querocotillo', 'San Felipe', 'San José del Alto', 'Santa Rosa'],
    ...
    'Huánuco': {
        ...
        'Leoncio Prado': ['Tingo María', 'Daniel Alomía Robles', 'Hermílio Valdizán', 'José Crespo y Castillo', 'Luyando', 'Mariano Dámaso Beraún', 'Pucayacu', 'Castillo Grande', 'Pueblo Nuevo', 'Santo Domingo de Anda'],
    ...
    'Ica': {
        ...
        'Chincha': ['Chincha Alta', 'Alto Larán', 'Chavin', 'Chincha Baja', 'El Carmen', 'Grocio Prado', 'Lurín Chincha', 'Pueblo Nuevo', 'San Juan de Yanac', 'San Pedro de Huacarpana', 'Sunampe', 'Tambo de Mora'],
    ...
    'Junín': {
        ...
        'Chupaca': ['Chupaca', 'Ahuac', 'Chongos Bajo', 'Huachac', 'Huamancaca Chico', 'San Juan de Yscos', 'San Aniceto de Parihuanca'],
    },
    'La Libertad': {
        'Trujillo': ['Trujillo', 'El Porvenir', 'Florencia de Mora', 'Huanchaco', 'La Esperanza', 'Laredo', 'Moche', 'Molino', 'Poroto', 'Salaverry', 'Simbal', 'Víctor Larco Herrera'],
    ...
    'Lima': {
        ...
        'Barranca': ['Barranca', 'Ámbar', 'Aucallama', 'Chancay', 'Huaral', 'Huarmey', 'Huacho', 'Supe', 'Supe Puerto'],
    ...
    'Loreto': {
        ...
        'Alto Amazonas': ['Yurimaguas', 'Balsapuerto', 'Barandiarán', 'Cahuapanas', 'Manseriche', 'Morona', 'Pastaza', 'Andoas'],
    ...
    'Piura': {
        ...
        'Sechura': ['Sechura', 'Bernal', 'Cristo Nos Valga', 'Vice', 'Rinconada Llicuar'],
    },
    'Puno': {
        ...
        'San Román': ['Juliaca', 'Cabana', 'Caracoto', 'San Miguel'],
        'Sandia': ['Sandia', 'Cuyocuyo', 'Limbani', 'Patambuco', 'Phara', 'Quiaca', 'San Juan del Oro', 'Yanahuaya', 'Alto Inambari', 'Inambari'],
    ...
    'San Martín': {
        ...
        'Picota': ['Picota', 'Buenos Aires', 'Caspizapa', 'Pilluana', 'Pucacaca', 'San Cristóbal', 'San Hilarión', 'Tingo de Ponasa', 'Tres Unidos'],
